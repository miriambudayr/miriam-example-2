...
import com.configure_me_miriam_example_2.api.client.MiriamExample2ClientImpl
...
/**
 * A class that allows building an instance of [MiriamExample2Client] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class MiriamExample2OkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [MiriamExample2Client]. */
         ...
         */
        @JvmStatic fun fromEnv(): MiriamExample2Client = builder().fromEnv().build()
    }

    /** A builder for [MiriamExample2OkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [MiriamExample2Client].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MiriamExample2Client =
            MiriamExample2ClientImpl(
                clientOptions
                    .httpClient(
