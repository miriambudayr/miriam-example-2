...
package com.configure_me_miriam_example_2.api.client.okhttp

import com.configure_me_miriam_example_2.api.client.MiriamExample2ClientAsync
import com.configure_me_miriam_example_2.api.client.MiriamExample2ClientAsyncImpl
...
/**
 * A class that allows building an instance of [MiriamExample2ClientAsync] with [OkHttpClient] as
 * the underlying [HttpClient].
 */
class MiriamExample2OkHttpClientAsync private constructor() {

    companion object {

        /**
         * Returns a mutable builder for constructing an instance of [MiriamExample2ClientAsync].
         */
         ...
         */
        @JvmStatic fun fromEnv(): MiriamExample2ClientAsync = builder().fromEnv().build()
    }

    /** A builder for [MiriamExample2OkHttpClientAsync]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [MiriamExample2ClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MiriamExample2ClientAsync =
            MiriamExample2ClientAsyncImpl(
                clientOptions
                    .httpClient(
